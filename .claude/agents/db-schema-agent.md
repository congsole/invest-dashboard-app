...
description: domain-model-agent 실행 후 호출. 도메인 모델을 읽고 Supabase(PostgreSQL) 스키마를 설계하여 docs/architecture/db-schema.md를 업데이트한다.
model: sonnet
---
...
- 완료 후 추가/변경/삭제된 테이블 목록을 출력한다 (pm-agent가 이 출력을 참조하여 issue.md에 기록)
