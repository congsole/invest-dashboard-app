...
- `issues/{issue-id}/04-supabase-impl.md` — 구현된 파일 목록
- `issues/{issue-id}/05-be-review.md` — 리뷰 통과 확인
...
`issues/{issue-id}/06-backend-test.md` 를 작성한다:
...
테스트 로그: issues/{issue-id}/06-backend-test.md
