...
// [016] get_or_recommend_stock_sector는 yfinance 기반 시그니처로 교체됨
//       (p_naver_industry → p_yfinance_sector/p_yfinance_industry)
//       현행 RPC 테스트는 016-sector-gics.test.ts가 커버한다.
